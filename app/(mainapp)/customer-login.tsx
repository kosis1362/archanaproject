    ...
    const handleAuth = async () => {
        ...
        try {
            if (isSignUp) {
                ...
                const res: any = await signUp(email, password, name, 'customer', phone, address);
                ...
                // Navigate to verification screen and pass role so we can return to correct login
                ...
                if (loggedInUser && !loggedInUser.isVerified) {
                    // Redirect to verification screen so user can resend/check status
                    setShowResend(true);
                    router.push(`/verify-email?email=${encodeURIComponent(email)}&role=customer`);
                    return;
                }
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.headerContainer}>
                    <Text style={styles.welcomeText}>
                        {isSignUp ? `${t('welcome')} ${t('appName')}` : 'Welcome to Bazaar'}
                    </Text>
                    <Text style={styles.subtitle}>
                        {isSignUp ? 'Create an account to start shopping' : 'Sign in to continue shopping'}
                    </Text>
                </View>
                ...
                <View style={styles.card}>
                    ...
                    >
                        ...
                        >
                            {isLoading ? (
                                ...
                                <Text style={styles.actionButtonText}>{isSignUp ? t('signUp') : t('signIn')}</Text>
                            )}
                        </LinearGradient>
                    </TouchableOpacity>
                    ...
                    <View style={styles.switchContainer}>
                        ...
                        <TouchableOpacity onPress={() => setIsSignUp(!isSignUp)}>
                            <Text style={styles.switchText}>{isSignUp ? t('signIn') : t('signUp')}</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </ScrollView>
